...
```bash
https://dev-botlxyzle.xyz/startConversation
```

Request Params | 
| ------------- | ------------- |
| BotID  | `string` <br />Required. Specifies which bot the message should be s| LanguageCode  | `string` <br /> Required. This is the language the user is using to interact with the bot. See **list of supported languages** to get the language codes.| * to get t|
...
url = "https://dev-botlhale.xyz/startConversation"
...
-->
```bash 
curl --location --request POST 'https://dev-botlhale.xyz/startConversation' \
...
fetch("https://dev-botlhale.xyz/startConversation", requestOptions)
...
```bash
https://dev-botlhale.xyz/message
```
...
| ConversationID  | `string` <br />Required. This is a unique Id that you have , rovi, image or pdfde to keep track of different conversations.| 
| MessageType  | `string` <br />Required. Spec or s whther the user message is speech or text.| 
| ResponseType  | `stringpe = 'text'. Text Message from the to user.|` <br />Required.user to the bot. | Specifies whether the response should be speech or text.|
| TextMsg  | `string` <br />Required if MessageTy
| ImageUrl  | `string` <br /> Required if the image.| 
| PdfUrl  | `string` <br /> Required if MessageType = 'pdf'. public url of the pdf document.| 




pe = 'text'. Text Message from the 
| Sthe `AuthepeechFile  | `file` <br /> Required if MessageTye = 'speech'. Binry audio file of the user's message.| <!-- theme: info -->

> ntication Token` in request headers. See how to 
[Generate Auth Token] user to the bot. 
...
url = "https://dev-botlhale.xyz/message"
...
-->
```bash 
curl --location --request POST 'https://dev-botlhale.xyz/message' \
-H "Authorization: Bearer <IdToken>" \
--form 'BotID="YPBDDDGASKSEVTHT"' \
--form 'LanguageCode="English"' \
...
fetch("https://dev-botlhale.xyz/message", requestOptions)
  .then(response => response.text())
  .then(result => console.log(result))
  .catch(error => console.log('error', error));
```
